...
{
    public class QRCodesModel3dShow : MonoBehaviour
    {
        public GameObject qrCodePrefab;
        public string currentQRCodeToShow;
        ...
        private void Instance_QRCodeAdded(object sender, QRCodeEventArgs<Microsoft.MixedReality.QR.QRCode> e)
        {
            ...
            Debug.Log("Code QR readed: " + e.Data.Data.ToString());
            if (currentQRCodeToShow == e.Data.Data.ToString())
            {
                lock (pendingActions)
                {
